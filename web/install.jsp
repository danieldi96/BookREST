...
private List<String> resetDatabase(boolean force) throws Exception {
        ...
        */
        ...
        String data[] = new String[]{
            ...
            "INSERT INTO " + dbname + ".BOOK(ASSESSMENT, DESCRIPTION, IMG, PRICE, TITLE, AUTHOR) VALUES (3, 'Infantil', 'img/caperucita.jpg', 11.0, 'Caperucita', 'AUTHOR1')",
            ...
            "INSERT INTO " + dbname + ".BOOK(ASSESSMENT, DESCRIPTION, IMG, PRICE, TITLE, AUTHOR) VALUES (1, 'Mayores', 'img/50sombras.jpg', 33.0, '50 Sombras de Grey', 'AUTHOR3')",
